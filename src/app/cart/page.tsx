...
export default function CartPage() {
  ...
  return <div className="cart-page">
    <header className="cart-hero" data-reveal="up">
      <div>
        <p className="eyebrow">ERGOCHAIR</p>
        <h1>Giỏ hàng<br /><em>của bạn.</em></h1>
        <p>Những lựa chọn thoải mái cho không gian làm việc của bạn.</p>
      </div>
      <div className="cart-hero-mark" data-reveal="scale" data-reveal-delay="100">
        <span className="cart-hero-number">{String(itemCount).padStart(2, "0")}</span>
